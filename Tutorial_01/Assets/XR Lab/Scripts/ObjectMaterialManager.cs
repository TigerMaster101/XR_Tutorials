...
public class ObjectMaterialManager : MonoBehaviour
{
    ...
    private void UpdateUI()
    {
        ...
        if (m_selectedMat.shader.name == "Standard" || m_selectedMat.shader.name == "Universal Render Pipeline/Lit")
        {
        ...
        {
            Debug.LogWarning("Warning: Shader " + m_selectedMat.shader.name + " is not supported, menu will not function correctly");
            return;
        }
    }
