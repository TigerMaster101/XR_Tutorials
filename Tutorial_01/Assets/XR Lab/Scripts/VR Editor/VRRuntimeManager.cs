...
public class VRRuntimeManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        UnityEngine.XR.Interaction.Toolkit.Locomotion.Teleportation.TeleportationProvider teleportationProvider = GameObject.FindFirstObjectByType<UnityEngine.XR.Interaction.Toolkit.Locomotion.Teleportation.TeleportationProvider>();
#else
        ...
        UnityEngine.XR.Interaction.Toolkit.Locomotion.Teleportation.TeleportationArea[] teleportationAreas = GameObject.FindObjectsByType<UnityEngine.XR.Interaction.Toolkit.Locomotion.Teleportation.TeleportationArea>(FindObjectsSortMode.None);
        UnityEngine.XR.Interaction.Toolkit.Locomotion.Teleportation.TeleportationAnchor[] teleportationAnchors = GameObject.FindObjectsByType<UnityEngine.XR.Interaction.Toolkit.Locomotion.Teleportation.TeleportationAnchor>(FindObjectsSortMode.None);
#else
        //getting arrays of all teleporter objects 
        ...
        foreach (UnityEngine.XR.Interaction.Toolkit.Locomotion.Teleportation.TeleportationArea ta in teleportationAreas)
        {
            ta.teleportationProvider = teleportationProvider;
        }

        //assigning references to teleportation providers
        foreach (UnityEngine.XR.Interaction.Toolkit.Locomotion.Teleportation.TeleportationAnchor tan in teleportationAnchors)
        {
