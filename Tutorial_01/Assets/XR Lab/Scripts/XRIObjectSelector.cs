...
namespace XRLab
{
    ...
    public class XRIObjectSelector : MonoBehaviour
    {
        ...
        [SerializeField] private UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor m_ray;
        ...
        {
            if (m_ray == null)
                m_ray = gameObject.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor>();
