...
public class XRIGrappleHook : MonoBehaviour
{
    ...
    [SerializeField] private UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor ray;
    ...
    void Awake()
    {
        ...
        ray = gameObject.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor>(); //getting the ray component
